...
export default function ServiceDetailPage() {
  ...
  const hasCaseStudy = !!(service.caseStudyImage || service.caseStudyVideo || service.caseStudyDescription);
          ...
          <div className="sd-casestudy-inner">
            <Reveal>
              <div className="sd-casestudy-header">
                ...
                {service.caseStudyDescription && (
                  <p className="sd-casestudy-desc">{service.caseStudyDescription}</p>
                )}
              </div>
            </Reveal>
            ...
            <Reveal delay={0.1}>
              <MediaBlock
                ...
                video={service.caseStudyVideo}
                imageAlt={`${service.title} case study`}
                onPreview={openPreview}
              />
            </Reveal>
          </div>
